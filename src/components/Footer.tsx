...
const Footer = () => {
  return (
    <footer className="bg-commerce-primary text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">CommerceCreek</h3>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input 
                ...
                className="px-4 py-2 rounded bg-white/10 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-commerce-accent"
              />
              <button 
                type="submit" 
                className="px-4 py-2 bg-commerce-accent hover:bg-commerce-accent/90 transition-colors rounded text-white font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} CommerceCreek. All rights reserved.
          </p>
